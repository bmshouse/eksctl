...
- xxx: link to [GitOps and how we use it
  here](/usage/experimental/gitops-flux/)
- xxx: what does it do
...
[ℹ]  please configure git@github.com:$USER/flux-get-started so that the following Flux SSH public key has write access to it
...
and actively deploying. Here's what you will see in your cluster:
...
- xxx: How a user can use `eksctl install flux` to apply more detailed
  flux configuration
